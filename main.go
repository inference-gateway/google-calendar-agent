// Code generated by ADL CLI v0.20.5 on 2025-09-17 01:27:25. DO NOT EDIT.
...
func main() {
	...
	googleDep, err := google.NewServiceFactory(l, &cfg)
	if err != nil {
		l.Fatal("failed to initialize google dependency", zap.Error(err))
	}

	// Register list_calendar_events skill
	listCalendarEventsSkill := skills.NewListCalendarEventsSkill(l, googleDep)
	...
	createCalendarEventSkill := skills.NewCreateCalendarEventSkill(l, googleDep)
	...
	updateCalendarEventSkill := skills.NewUpdateCalendarEventSkill(l, googleDep)
	...
	deleteCalendarEventSkill := skills.NewDeleteCalendarEventSkill(l, googleDep)
	...
	getCalendarEventSkill := skills.NewGetCalendarEventSkill(l, googleDep)
	...
	findAvailableTimeSkill := skills.NewFindAvailableTimeSkill(l, googleDep)
	...
	checkConflictsSkill := skills.NewCheckConflictsSkill(l, googleDep)
