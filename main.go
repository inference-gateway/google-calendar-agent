// Code generated by ADL CLI v0.20.4 on 2025-09-16 22:39:23. DO NOT EDIT.
...
func main() {
	...
	listCalendarEventsSkill := skills.NewListCalendarEventsSkill(l)
	...
	createCalendarEventSkill := skills.NewCreateCalendarEventSkill(l)
	...
	updateCalendarEventSkill := skills.NewUpdateCalendarEventSkill(l)
	...
	deleteCalendarEventSkill := skills.NewDeleteCalendarEventSkill(l)
	...
	getCalendarEventSkill := skills.NewGetCalendarEventSkill(l)
	...
	findAvailableTimeSkill := skills.NewFindAvailableTimeSkill(l)
	...
	checkConflictsSkill := skills.NewCheckConflictsSkill(l)
