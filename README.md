...
|-------|-------------|--------|
| `schedule-meeting` | Use this when the user asks to schedule a meeting, book a slot, or find a time that works. Resolves a conflict-free booking by finding open slots, validating no overlap, and creating the event. | bare scaffold (`.agents/skills/schedule-meeting/SKILL.md`) |
...
- `VERSION` - Agent version (default: `0.5.12`)
