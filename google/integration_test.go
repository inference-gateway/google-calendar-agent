...
func TestCalendarServiceIntegration(t *testing.T) {
	...
	service, err := google.NewCalendarService(ctx, logger, option.WithCredentialsFile("testdata/service-account.json"))
...
func TestNewCalendarService(t *testing.T) {
	...
	t.Run("SuccessWithValidOptions", func(t *testing.T) {
		service, err := google.NewCalendarService(ctx, logger)
	...
	t.Run("WithCustomOptions", func(t *testing.T) {
		service, err := google.NewCalendarService(ctx, logger, option.WithCredentialsFile("nonexistent.json"))
